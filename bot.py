...
ANALYTICS_USERS = [7555663197,952362307,7784661572,687433966] # --- Юрій, Денис, Сергій, Олександр
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Якщо у ІПН переплутані цифри, то працівник перевірятися не буде "
        "та вам у телеграм прийде сповіщення у форматі:\n"
