...
async def ask_analytics_date(update,context):
    await update.massage.reply_text("📅 Введіть дату у форматі дд.мм.рр (наприклад 05.07.24):")
...
analytics_conv = ConversationHandler(
    ...
    states={
        ...
        # Додаткові стани для обробки введених дат/statistics будуть додані пізніше
    },
